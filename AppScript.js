function makeAttendanceSheet() {
    ...
    var title = String("Attendance " + today);
  ...
  // CONTINUE explicitly because page navigation cannot be mixed with non-navigation choices.
    ...
    item.setTitle("Are you a new member?")
        .setHelpText("If you have never attended a GBM, select yes. If you have attended at least one prior GBM, select no")
